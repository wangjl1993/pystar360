...
class pyStar360Robot(pyStar360RobotBase):
    ...
    def run(self):
        ...
        # save_path = SETTINGS.DATASET_PATH / "new1415cutpoints"  / "images" / "train"
        # self._dev_generate_cutpoints_(save_path)

        # save_path = SETTINGS.DATASET_PATH / "1213anchors_extra" / "images" / "train"
        # self._dev_generate_anchors_(save_path, label_list=["2"])

        # self._dev_generate_items_template_(self.output_save_path)
