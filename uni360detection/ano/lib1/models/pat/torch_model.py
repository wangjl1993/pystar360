...
from uni360detection.ano.lib1.models.components import (
    DynamicBufferModule,
    FeatureExtractor,
    KCenterGreedy,
)
from uni360detection.ano.lib1.models.pat.anomaly_map import AnomalyMapGenerator
from uni360detection.ano.lib1.pre_processing import Tiler
...
class PatchcoreModel(DynamicBufferModule, nn.Module):
    ...
    def __init__(
        ...
        self.feature_extractor = FeatureExtractor(backbone=self.backbone(), layers=self.layers)
