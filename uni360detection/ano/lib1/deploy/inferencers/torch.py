...
# from uni360detection.ano.lib1.deploy.optimize import get_model_metadata
from uni360detection.ano.lib1.models import get_model
from uni360detection.ano.lib1.models.components import AnomalyModule
from uni360detection.ano.lib1.pre_processing import PreProcessor
...
class TorchInferencer(Inferencer):
    ...
    def __init__(
        ...
        if isinstance(model_source, AnomalyModule):
            ...
            self.model = self.load_model(model_source, model_backbone_path, device)
