'''
Author: your name
Date: 2021-08-23 14:47:34
LastEditTime: 2021-08-23 15:18:46
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /albert/highspeedrail/src/models/ganomaly.py
...
class NetG(nn.Module):
    ...
    def __init__(self, opt):
        ...
        self.encoder1 = Encoder(opt["input_size"], opt["latent_dim"],
                                opt["in_channels"], opt["ngf"], 1)
        self.decoder = Decoder(opt["input_size"], opt["latent_dim"],
                               opt["in_channels"], opt["ngf"], 1)
        self.encoder2 = Encoder(opt["input_size"], opt["latent_dim"],
                                opt["in_channels"], opt["ngf"], 1)
